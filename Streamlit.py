...
with st.sidebar:
    ...
    subject = st.selectbox("과목을 선택하세요", ["수학", "과학", "국어", "영어", "사회", "역사"])
...
concepts = {
    "중1": {
        ...
        "국어": {
            "1학기 중간고사": ["문학과의 만남", "바람직한 언어생활"],
            "1학기 기말고사": ["요약하며 읽기", "갈등을 넘어"],
            "2학기 중간고사": ["성장 소설과 수필", "매체와 추론하며 듣기"],
            "2학기 기말고사": ["품사와 단어의 짜임", "추론하며 읽고 논설문 쓰기"],
        },
        "영어": {
            "1학기 중간고사": ["현재진행형", "조동사"],
            "1학기 기말고사": ["의문사", "과거시제"],
            "2학기 중간고사": ["비교급과 최상급", "동명사"],
            "2학기 기말고사": ["to부정사", "접속사"],
        },
        "사회": {
            "1학기 중간고사": ["세계화와 지리", "아시아", "유럽"],
            "1학기 기말고사": ["아프리카", "아메리카", "오세아니아와 극지방"],
            "2학기 중간고사": ["인간과 사회생활", "다양한 문화의 이해", "민주주의와 시민"],
            "2학기 기말고사": ["정치과정과 시민 참여", "일상생활과 법", "인권과 기본권"],
        },
    },
    "중2" : {
        "수학": {
